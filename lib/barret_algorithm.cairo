...
from lib.multi_precision_bigint12 import (
    multi_precision_bigint12 as mp12,
    find_lead_limb_index_bigint12,
)
...
func barret_reduction{range_check_ptr}(number : BigInt12) -> (remainder : BigInt6):
    alloc_locals
    ...
    with_attr error_message("A"):
        let m_bigint6 = BigInt6(
            d0=13402431016077863595,
...
func get_r2{range_check_ptr}(q3_bigint12 : BigInt12, m_bigint6 : BigInt6) -> (
    ...
    let (q3_times_m_bigint18) = mp12.mul_bigint12_by_bigint6(q3_bigint12, m_bigint6)
